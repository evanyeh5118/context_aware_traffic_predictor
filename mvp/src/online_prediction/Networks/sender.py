...
# Get path to mvp root (4 levels up from this file)
_current_file = os.path.abspath(__file__)
_mvp_root = os.path.dirname(os.path.dirname(os.path.dirname(os.path.dirname(_current_file))))
CSV_FILE = os.environ.get(
    "CSV_FILE",
    os.path.join(_mvp_root, "data", "sender", "traffic_dataset.csv")
)
